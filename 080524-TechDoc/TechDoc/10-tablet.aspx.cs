    ...
    public partial class tablet : System.Web.UI.Page
    {
        ...
        private void FetchData(string brand)
        {
            string query = @"
                ...
                WHERE [brand_id] IN (
                    SELECT [brand_id] 
                    FROM [Techdoc].[dbo].[techdoc_tabletbrand] 
        ...
        {
            //Response.Redirect("entermodel.aspx");
        }
        ...
        // Method to filter GridView based on search keyword
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 //////////////////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            // Check if any mandatory fields are empty, including TextBox2
        ...
        protected void TextBox4_TextChanged(object sender, EventArgs e)
        {
           ...
           // Session["complaint_id"] = TextBox4.Text.Trim();
            //changesMade = true;
        }
